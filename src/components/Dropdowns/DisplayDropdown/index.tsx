    ...
    <div className='display-dropdown' ref={componentRef}>
      ...
      <div className={`dropdown-content-container ${visible && "visible"}`}>
        <div className='dropdown-content-row'>
          ...
          <select className='dropDown' name="grouping" id="grouping" value={grouping} onChange={onGroupingChange}>
        ...
        <div className='dropdown-content-row'>
          ...
          <select className='dropDown' name="ordering" id="ordering" value={ordering} onChange={onOrderingChange}>
            <option value="priority">Priority</option>
